...
// rgba через CSS.
 ...
 canvas 111111111111111 = document.getElementById("canvas");
 ctx 111111111111111= canvas.getContext("2d"); // Получаем контекст 2D рисования
...
const image = new Image();
 image.onload = () => {
 ctx.drawImage(image, 0, 600, 150, 150);
 };
...
// const lingrad2 = ctx.createLinearGradient(0, 0, 500, 500);
// lingrad2.addColorStop(0, 'red');
// function randomColor(){
//     return `rgb()`
// }
// lingrad2.addColorStop(0.5, 'green');
